...
const allCourses = [
  ...
  },
  {
    ...
    price: 69.99,
    image:
      "https://images.unsplash.com/photo-1599447462453-03b12652e528?q=80&w=2070&auto=format&fit=crop",
  },
  {
    id: "full-stack-mern",
...
export function CoursesPage() {
  return (
    <div className="bg-[#0a0f1f] min-h-screen w-full text-gray-300">
      <div className="container mx-auto max-w-7xl px-6 py-12 space-y-16">
        ...
        {/* Courses Grid */}
        <section>
          <h2 className="text-4xl font-extrabold tracking-tight mb-10 bg-clip-text text-transparent bg-gradient-to-r from-cyan-400 to-purple-400 drop-shadow-lg">
            Explore Our Courses
          </h2>
